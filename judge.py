...
class JudgementResult(BaseModel):
	...
	failure_reason: str | None = Field(default=None, description='Why the task was not completed successfully')
	impossible_task: bool = Field(default=False, description='True if task was impossible to complete')
...
def construct_judge_messages(
	...
	Args:
		...
		screenshots_b64: List of base64 encoded screenshot strings
